...
grails {
    mail {
        host = "dev.care.net"
        port = "25"
        fromEmailAddress = "CARE Admin <admin@test.aps.force5solutions.com>"
        username = "username"
        password = "password"
        defaultEmail {
            from = "CARE Admin <admin@test.aps.force5solutions.com>"
        }
    }
}
...
careCentral {
    webService {
        username = "admin"
        password = "admin"
        url = "http://qa.care.force5solutions.com/services/careCentral"
    }
}
sendEmail = "false"
