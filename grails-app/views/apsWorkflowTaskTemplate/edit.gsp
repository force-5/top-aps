...
<g:hiddenField name="version" value="${apsWorkflowTaskTemplate?.version}"/>
...
<tr class="prop">
    ...
    <td valign="top"
        ...
        <g:textField name="templateName"
                     value="${apsWorkflowTaskTemplate.id}" style="width:600px;color: #808080;background-color:#f2f2f2;" readonly="true"/>
    </td>
</tr>
<tr class="prop">
    <td valign="top" class="name">
...
<tr class="prop">
    ...
    <td valign="top"
        ...
        <g:select name="actions" from="${['APPROVE', 'REJECT', 'CONFIRM']}" multiple="yes" size="3"
                  value="${apsWorkflowTaskTemplate?.actions}" style="width:300px;border: 1px solid #000;color: #808080;background-color:#f2f2f2;" disabled="true"/>
    </td>
</tr>
...
<tr class="prop">
    ...
    <td valign="top"
        ...
        <g:select name="escalationTemplate.id" style="width: 610px;"
                  from="${ApsWorkflowTaskTemplate.list()}"
