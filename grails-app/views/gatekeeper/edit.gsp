<%@ page import="org.codehaus.groovy.grails.commons.ConfigurationHolder; com.force5solutions.care.aps.Gatekeeper" %>
<html>
<head>
...
<div class="body">
    ...
    <g:hasErrors bean="${gatekeeper}">
        <div class="errors">
            <g:renderErrors bean="${gatekeeper}" as="list"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
        <g:hiddenField name="id" value="${gatekeeper?.id}"/>
        <g:hiddenField name="version" value="${gatekeeper?.version}"/>
        <div class="dialog">
            <table>
                <tbody>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: gatekeeper, field: 'firstName', 'errors')}">
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: gatekeeper, field: 'lastName', 'errors')}">
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: gatekeeper, field: 'slid', 'errors')}">
