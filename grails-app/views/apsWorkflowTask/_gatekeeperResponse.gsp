...
<div id="wrapper">
    ...
    <div style="margin:0 50px;font-size:14px;">
        <div>
            <span>
                ...
                <g:elseif test="${task.workflowType in [ApsWorkflowType.ROLE_REVOKE_REQUEST, ApsWorkflowType.CANCEL_ACCESS_APPROVAL]}">
                    <g:set var="taskDescription"
                           value="${CareConstants.CANNED_RESPONSE_APS_REVOKE_REQUEST_GATEKEEPER_JUSTIFICATION}"/>
                    Revocation for <b>${task.workerEntitlementRole}</b> on worker <b>${task.worker.toString()}</b> has been requested. This request requires your approval and business justification.
                </g:elseif>
                <br/>
                <br/>
            </span>
    ...
    <h1>Worker Certification Information</h1>
    ...
    <h1>Comments</h1><br/>
    <care:historyByWorkerEntitlementRoleId workerEntitlementRoleId="${task.workerEntitlementRoleId}"/>
</div>
