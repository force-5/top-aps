    ...
    <div style="margin:0 50px;font-size:14px;">
        ...
        <div>
            <span>
                ...
                <br/>
                <br/>
                This request NOW stands completed.
                <br/>
                <br/>
                This task was marked completed by: <b>${task?.actorSlid}</b> at <b><g:formatDate date="${task?.lastUpdated}" format="MM/dd/yyyy, hh:mm a"/></b>
                <br/>
                <br/>
                <br/>
            </span>
